...
public:
  ...
  bool getJudge(void);
  int getSum(void);
  int getSumFirst(void);
  int getResult(void);
  void show(void);
  ~int_sum_push(void);
};
int_sum_push::~int_sum_push(void)
{
  this->value01 = (int)NULL;
...
void int_sum_push::setJudge(bool judge)
{
  this->Judge = judge;
}
bool int_sum_push::getJudge(void)
{
  return this->Judge;
}
int int_sum_push::getInput(void)
{
  return this->value01;
}
int int_sum_push::getSum(void)
{
  return this->sum;
}
int int_sum_push::getSumFirst(void)
{
  return this->sum_first;
}
int int_sum_push::getResult(void)
{
  return this->result;
}
void int_sum_push::setValue(int value1)
{
  this->value01 = 0;
  this->value001 = 0;
  this->sum_first = 0;
...
void int_sum_push::space(int value)
{
  if (value < 10) {
    std::cout << "            *" << std::endl;
  } else if (value < 100) {
...
{
  std::cout << "This program calculate a push sum first value at integer value." << std::endl;
...
int main(void)
{
  ...
  consultant lady;
  lady.msg01();
  if (std::cin >> value01) {} else {lady.msg07();
    value01 = (int)NULL;
    return 1;}
